package com.limluc.sandbox.repository;

import com.limluc.sandbox.SandboxApp;
import com.limluc.sandbox.config.Constants;
import com.limluc.sandbox.config.audit.AuditEventConverter;
import com.limluc.sandbox.domain.PersistentAuditEvent;
...
import static com.limluc.sandbox.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
